...
export class Backend implements backendInterface {
    ...
    async getIsUnlocked(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.getIsUnlocked();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveAppPassword(arg0: PasswordHash): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveAppPassword(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async unlockAccount(arg0: PasswordHash): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.unlockAccount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
